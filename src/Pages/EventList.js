...
import { Container, Typography, CircularProgress, Grid, Paper, Collapse, Card, CardContent, Button, Grow, Box } from '@mui/material';
              ...
              <div> {/* Wrapping StyledCard in a div to avoid transition issues */}
                <StyledCard>
                  <CardContent>
                    ...
                    <StyledButton fullWidth variant="contained" onClick={() => handleViewDetails(event._id)}>
                      View Details
                    </StyledButton>
                  </CardContent>
                </StyledCard>
